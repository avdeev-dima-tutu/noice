...
fun assertSnapshot2(expect: ExpectSnapshotData, actual: Snapshot, description: String = "") {
    runBlocking {
        ...
        sendMultipart(
            uploadServer = "http://10.0.2.2:9001",
...
suspend fun sendMultipart(uploadServer: String = "http://127.0.0.1:9001", name:String = "file.bin", fileBytes: ByteArray = byteArrayOf(1, 2, 3, 4)): String {
